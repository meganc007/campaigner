  ...
  return (
    <div className="flex flex-col p-4 md:p-6 lg:p-12">
      ...
      <div className="grid grid-cols-2 text-center md:w-2/3 md:mx-auto">
        <div className="p-2 border-t-2 border-t-black border-r-2 border-r-black">
        ...
        <div className="p-2 border-t-2 border-t-black">
        ...
        <div className="p-2 col-span-2 border-t-2 border-t-black">
