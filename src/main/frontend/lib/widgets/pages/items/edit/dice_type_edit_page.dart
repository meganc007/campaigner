...
class _DiceTypeEditPageState extends State<DiceTypeEditPage> {
  ...
  void initState() {
    super.initState();
    _nameController.text = widget.diceType.name;
    widget.diceType.description != null
        ? _descriptionController.text = widget.diceType.description!
        : _descriptionController.text = '';
    _maxRollController.text = widget.diceType.maxRoll!.toString();
  }
  ...
  Future<void> _submitForm() async {
    ...
    final success = await editDiceType(
      widget.diceType.id,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Edit ${widget.diceType.name}".toUpperCase())),
      body: Padding(
