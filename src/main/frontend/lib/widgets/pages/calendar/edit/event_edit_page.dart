...
class EventEditPage extends StatefulWidget {
  final String uuid;
  final Event event;
  const EventEditPage({super.key, required this.uuid, required this.event});
    ...
    try {
      ...
      setState(() {
        ...
        _selectedMonth = _months.firstWhereOrNull(
          (month) => month.id == widget.event.fkMonth,
        );
        _selectedWeek = _weeks.firstWhereOrNull(
          (week) => week.id == widget.event.fkWeek,
        );
        _selectedDay = _days.firstWhereOrNull(
          (day) => day.id == widget.event.fkDay,
        );
        _selectedContinent = _continents.firstWhereOrNull(
          (continent) => continent.id == widget.event.fkContinent,
        );
        _selectedCountry = _countries.firstWhereOrNull(
          (country) => country.id == widget.event.fkCountry,
        );
