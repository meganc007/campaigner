...
class AddJobAssignmentPage extends StatefulWidget {
  final String uuid;
  const AddJobAssignmentPage({super.key, required this.uuid});

  @override
  State<AddJobAssignmentPage> createState() => _AddJobAssignmentPageState();
}

class _AddJobAssignmentPageState extends State<AddJobAssignmentPage> {
  ...
  Future<void> _submitForm() async {
    ...
    final success = await createJobAssignment(
      _selectedPerson?.id,
      _selectedJob?.id,
      widget.uuid,
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Create Job Assignment".toUpperCase())),
      body: Padding(
