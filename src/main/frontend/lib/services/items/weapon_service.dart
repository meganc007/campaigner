...
Future<List<Weapon>> fetchWeapons(String uuid) async {
  final response = await http.get(
    Uri.parse('${Api.baseUrl}/weapons/campaign/$uuid'),
  );
...
Future<Weapon> fetchWeapon(int id) async {
  final response = await http.get(Uri.parse('${Api.baseUrl}/weapons/$id'));
...
Future<bool> editWeapon(
  ...
  final response = await http.put(
    Uri.parse('${Api.baseUrl}/weapons/$id'),
    headers: {'Content-Type': 'application/json'},
    body: jsonEncode({
      "id": id,
      "name": name,
...
Future<void> deleteWeapon(int id) async {
  final response = await http.delete(Uri.parse('${Api.baseUrl}/weapons/$id'));
