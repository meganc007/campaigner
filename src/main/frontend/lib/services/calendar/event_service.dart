...
Future<List<Event>> fetchEvents(String uuid) async {
  final response = await http.get(Uri.parse('${Api.baseUrl}/events'));
...
Future<Event> fetchEvent(int id) async {
  final response = await http.get(Uri.parse('${Api.baseUrl}/events/$id'));
...
Future<bool> editEvent(
  ...
  final response = await http.put(
    Uri.parse('${Api.baseUrl}/events/$id'),
    headers: {'Content-Type': 'application/json'},
    body: jsonEncode({
      "id": id,
      "name": name,
...
Future<void> deleteEvent(int id) async {
  final response = await http.delete(Uri.parse('${Api.baseUrl}/events/$id'));
